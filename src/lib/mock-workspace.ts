...
export const archNodes: ArchNode[] = [
  {
    ...
    x: 50,
    y: 8,
    purpose: "The React application shell. Bootstraps providers and mounts the router.",
    connections: ["router"],
  ...
  },
  {
    ...
    x: 50,
    y: 22,
    purpose: "Maps URLs to page components. Central navigation contract.",
    connections: ["pages", "auth"],
    files: ["src/router.ts"],
  },
  {
    id: "auth",
    ...
    x: 15,
    y: 35,
    purpose: "JWT validation and session lifecycle. Guards protected routes.",
  ...
  },
  {
    ...
    x: 70,
    y: 35,
    purpose: "Route-level compositions that assemble smaller pieces.",
    connections: ["components", "hooks"],
    files: ["src/pages/*"],
  },
  {
    id: "components",
  ...
  },
  {
    ...
    x: 55,
    y: 52,
    purpose: "Stateful logic shared across the tree.",
  ...
  },
  {
    ...
    x: 30,
    y: 68,
    purpose: "Outward communication — HTTP, auth, persistence.",
    connections: ["api"],
    files: ["src/services/*"],
  },
  {
    ...
    x: 55,
    y: 82,
    purpose: "External data boundary. Every network call passes through here.",
    connections: ["utils"],
  ...
  },
  {
    ...
    x: 80,
    y: 82,
    purpose: "Pure helpers. Deterministic and dependency-free.",
    connections: [],
    files: ["src/utils/*"],
  },
];
...
export const dependencies: DepNode[] = [
  {
    id: "react",
    label: "React",
    role: "UI runtime — component tree and reconciliation.",
    depends: [],
  },
  {
    id: "router",
    label: "React Router",
    role: "Client-side navigation on top of React.",
    depends: ["react"],
  },
  {
    id: "query",
    label: "TanStack Query",
    role: "Server-state cache. Sits between UI and network.",
    depends: ["react"],
  },
  {
    id: "axios",
    label: "Axios",
    role: "HTTP transport. Query calls Axios under the hood.",
    depends: ["query"],
  },
  {
    id: "zod",
    label: "Zod",
    role: "Runtime schema validation for API payloads.",
    depends: ["axios"],
  },
];
...
export const techStack: TechCategory[] = [
  ...
  {
    name: "Build",
    items: [{ name: "Vite", why: "Fast dev server with native ESM. Replaces Webpack." }],
  },
  {
    name: "Testing",
    items: [{ name: "Vitest", why: "Vite-native test runner. Shares config with the app." }],
  },
  {
    name: "Deployment",
    items: [{ name: "Vercel", why: "Edge hosting with preview deployments per branch." }],
  },
];
...
export const observations: Observation[] = [
  {
    id: "o1",
    title: "Authentication begins inside auth.ts",
    detail: "All JWT handling routes through a single module.",
    why: "One file to read to understand the entire auth story.",
  },
  {
    id: "o2",
    title: "Largest component is Dashboard.tsx",
    detail: "420 lines — five distinct responsibilities in one file.",
    why: "A likely candidate for extraction. Splitting improves readability.",
  },
  {
    id: "o3",
    title: "Most imported utility is cn()",
    detail: "Referenced by 84% of components.",
    why: "A change here ripples widely — read it before touching styles.",
  },
  {
    id: "o4",
    title: "README coverage is excellent",
    detail: "Every top-level folder is described in the README.",
    why: "Trust the README. It's a reliable map, not marketing.",
  },
  {
    id: "o5",
    title: "Components folder has high cohesion",
    detail: "Each file owns one visual concern with minimal cross-imports.",
    why: "Safe to read files in isolation — few hidden dependencies.",
  },
];
...
export const insights: Insight[] = [
  {
    id: "i1",
    headline: "Largest component",
    detail: "Dashboard.tsx is 420 lines with 5 concerns.",
    recommendation: "Extract Header, Charts, and Sidebar into siblings.",
  },
  {
    id: "i2",
    headline: "Duplicate utility functions",
    detail: "formatDate and toDateStr do the same work in two folders.",
    recommendation: "Consolidate into utils/date.ts.",
  },
  {
    id: "i3",
    headline: "Authentication is well isolated",
    detail: "Auth code touches only three files.",
    recommendation: "Preserve this boundary in future changes.",
  },
  {
    id: "i4",
    headline: "Test coverage is uneven",
    detail: "Services are 91% covered. UI is 34%.",
    recommendation: "Prioritise tests for Dashboard.tsx and Home.tsx.",
  },
];
