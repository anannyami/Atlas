    ...
    items: [
      {
        ...
        version: "19.0.0",
        purpose: "UI library",
        usedInFiles: ["src/routes/", "src/components/"],
        popularity: 99,
      ...
      },
      {
        ...
        version: "1.x",
        purpose: "Type-safe file routing",
        usedInFiles: ["src/routes/"],
        popularity: 84,
    ...
    items: [
      {
        ...
        usedInFiles: ["src/styles.css", "src/components/"],
        popularity: 96,
      ...
      },
      {
        ...
        version: "12.x",
        purpose: "Animations",
        usedInFiles: ["src/components/", "src/routes/"],
        popularity: 78,
    ...
    items: [
      {
        ...
        version: "19.0.0",
        purpose: "Local + shared state",
        usedInFiles: ["src/hooks/", "src/routes/"],
        popularity: 92,
    ...
    items: [
      {
        name: "GitHub OAuth",
        version: "—",
        purpose: "Sign-in and repo access",
        usedInFiles: ["src/services/AuthService.ts"],
        popularity: 90,
    ...
    items: [
      {
        name: "Docker",
        version: "27.x",
        purpose: "Runtime container",
        usedInFiles: ["Dockerfile", "docker-compose.yml"],
        popularity: 93,
    ...
    items: [
      {
        name: "Vite",
        version: "7.0.1",
        purpose: "Bundler & dev server",
        usedInFiles: ["vite.config.ts"],
        popularity: 96,
...
export const mockInsights: InsightItem[] = [
  {
    ...
    description:
      "`src/routes/index.tsx` imports from `src/services/AuthService.ts`, which re-imports a helper that reaches back into routes.",
    ...
    suggestedFix:
      "Extract the shared helper into `src/lib/session.ts` so both sides depend on a leaf module.",
  },
  {
    id: "ins-large",
    category: "large-file",
    ...
    description:
      "The Overview panel is doing too much: layout, data shaping, and analytics all live together.",
    ...
    suggestedFix:
      "Split into `OverviewHeader`, `OverviewStats`, and `OverviewTimeline` components.",
  },
  {
    id: "ins-nesting",
  ...
  },
  {
    ...
    description:
      "`initials` in `lib/auth.ts` and `readingOrder` in `mock-workspace.ts` have no callers outside their own files.",
    affectedFiles: ["src/lib/auth.ts", "src/lib/mock-workspace.ts"],
    reason: "Dead exports mislead consumers and pad the bundle.",
    suggestedFix:
      "Delete them or wire them into the components that were originally planned to use them.",
  },
  {
    id: "ins-security",
  ...
  },
  {
    ...
    description:
      "None of the exports in `src/services/*` document their parameters or return shape.",
    ...
    suggestedFix:
      "Add a one-line JSDoc summary per exported function; leave complex types to the DTO.",
  },
  {
    id: "ins-a11y",
  ...
  const seed: SearchHit[] = [
    {
      ...
      path: "src/services/AuthService.ts",
      context: "export async function signIn(...)",
    },
    {
      id: "s2",
      kind: "component",
      label: "RepositoryCard",
      path: "src/components/workspace/RepositoryCard.tsx",
      context: "Renders a repository summary card",
    },
    {
      id: "s3",
      kind: "hook",
      ...
      context: "Returns { user, isAuthenticated, disconnect }",
    },
    {
      id: "s4",
      kind: "function",
      ...
      path: "src/lib/auth.ts",
      context: "Simulates the GitHub OAuth round-trip",
    },
    {
      id: "s5",
      kind: "route",
    ...
    },
    {
      ...
      path: "src/services/types.ts",
      context: "extends RepositorySummary",
    },
    {
      id: "s7",
      kind: "constant",
      label: "LANGUAGE_COLORS",
    ...
    },
    {
      ...
      path: "vite.config.ts",
      context: "TanStack Start plugin",
    },
  ];
  if (!q) return seed;
  return seed.filter(
    (s) => s.label.toLowerCase().includes(q) || s.context.toLowerCase().includes(q),
  );
}
